...
if __name__ == "__main__":
    audio_path = "audios/0.mp3"
    images_count = 30
    image_paths = [f"images/{n}.jpg" for n in range(images_count)]
    image_durations = [2] * images_count # In seconds
    frame_size = (1920, 1080)
    frame_rate = 30
    clip_path = "videos/clip.mp4"
    generate_image_sequence_clip(audio_path, image_paths, image_durations, frame_size, frame_rate, clip_path)
